...
class Settings:
    ...
    llm_judge_temperature: float = float(os.getenv("LLM_JUDGE_TEMPERATURE", "0"))
    llm_judge_num_predict: int = int(os.getenv("LLM_JUDGE_NUM_PREDICT", "200"))
    llm_answer_temperature: float = float(os.getenv("LLM_ANSWER_TEMPERATURE", "0.4"))
    llm_answer_num_predict: int = int(os.getenv("LLM_ANSWER_NUM_PREDICT", "160"))
